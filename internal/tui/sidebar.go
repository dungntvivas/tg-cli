...
// groups/channels it's the chat title. The chat pane banner (set via
// setChatHeader) carries the "chat - X" labeling instead, so the list
// itself just shows the raw identifier — easier to scan visually.
